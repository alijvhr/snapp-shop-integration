...
final class Snapp_Shop_Settings
{
    ...
    public function enqueue_assets(string $hook): void
    {
        ...
        wp_enqueue_style('snapp-shop-admin', SNAPP_SHOP_PLUGIN_URL . 'assets/css/admin.css', [], '1.1.0');
        wp_enqueue_script('snapp-shop-admin', SNAPP_SHOP_PLUGIN_URL . 'assets/js/admin.js', [], '1.1.0', true);
    }
